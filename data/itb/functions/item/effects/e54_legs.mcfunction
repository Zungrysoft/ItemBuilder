...
execute store result score counter value run data get entity @s Inventory[{Slot:101b}].tag.ItemBuilderCounter1
...
item modify entity @s armor.legs itb:set_counter1
