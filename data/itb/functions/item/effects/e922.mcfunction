...
# Sound Effect
execute if score cur_slot value matches 2..6 unless score effect_nosound value matches 1 run playsound minecraft:entity.player.attack.nodamage player @a
execute if score cur_slot value matches 2..6 unless score effect_nosound value matches 1 run playsound minecraft:item.armor.equip_turtle player @a ~ ~ ~ 1 1.3
