...
execute store success score effect_given value run effect give @s minecraft:invisibility 5 0 false

# If the effect was successfully given, set the passive potion effect flag
execute unless score effect_given value matches 0 run scoreboard players set @s itbg_invisibilit 1
