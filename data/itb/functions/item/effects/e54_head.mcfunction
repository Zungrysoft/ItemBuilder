...
execute store result score counter value run data get entity @s Inventory[{Slot:103b}].tag.ItemBuilderCounter1
...
item modify entity @s armor.head itb:set_counter1
