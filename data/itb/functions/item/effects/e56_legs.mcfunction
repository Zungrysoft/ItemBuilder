...
execute store result score counter value run data get entity @s Inventory[{Slot:101b}].tag.ItemBuilderCounter2
...
item modify entity @s armor.legs itb:set_counter2
