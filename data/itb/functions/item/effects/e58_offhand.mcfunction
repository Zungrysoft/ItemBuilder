...
execute store result score counter value run data get entity @s Inventory[{Slot:-106b}].tag.ItemBuilderCounter3
...
item modify entity @s weapon.offhand itb:set_counter3
