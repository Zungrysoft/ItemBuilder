...
execute if score effect_value value matches 5 store success score effect_given value run effect give @s minecraft:jump_boost 5 5 false
execute if score effect_value value matches 6 store success score effect_given value run effect give @s minecraft:jump_boost 5 6 false
execute if score effect_value value matches 7 store success score effect_given value run effect give @s minecraft:jump_boost 5 7 false
execute if score effect_value value matches 8 store success score effect_given value run effect give @s minecraft:jump_boost 5 8 false
execute if score effect_value value matches 9 store success score effect_given value run effect give @s minecraft:jump_boost 5 9 false

# If the effect was successfully given, set the passive potion effect flag
execute unless score effect_given value matches 0 run scoreboard players set @s itbg_jump_boost 1
