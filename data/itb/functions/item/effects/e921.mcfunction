...
# Sound Effect
execute unless score effect_nosound value matches 1 unless score no_item value matches 1.. run playsound minecraft:entity.player.attack.nodamage player @a
execute unless score effect_nosound value matches 1 unless score no_item value matches 1.. run playsound minecraft:entity.player.attack.sweep player @a ~ ~ ~ 1 2
