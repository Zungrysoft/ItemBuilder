...
# Reload the crossbow
item modify entity @s hotbar.5 itb:load_crossbow

# Reload multishot crossbow
execute if entity @s[nbt={Inventory:[{Slot:5b,tag:{Enchantments:[{id:"minecraft:multishot"}]}}]}] run item modify entity @s hotbar.5 itb:load_crossbow_multishot
