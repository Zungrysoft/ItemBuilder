...
# Reload the crossbow
item modify entity @s weapon.mainhand itb:load_crossbow

# Reload multishot crossbow
execute if entity @s[nbt={SelectedItem.tag.Enchantments:[{id:"minecraft:multishot"}]}] run item modify entity @s weapon.mainhand itb:load_crossbow_multishot
