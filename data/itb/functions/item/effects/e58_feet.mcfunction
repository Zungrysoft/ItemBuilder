...
execute store result score counter value run data get entity @s Inventory[{Slot:100b}].tag.ItemBuilderCounter3
...
item modify entity @s armor.feet itb:set_counter3
