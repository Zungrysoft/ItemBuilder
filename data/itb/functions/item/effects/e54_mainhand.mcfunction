...
execute store result score counter value run data get entity @s SelectedItem.tag.ItemBuilderCounter1
...
item modify entity @s weapon.mainhand itb:set_counter1
