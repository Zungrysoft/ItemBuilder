...
# Hunger
execute if score effect_value value matches 50 run function itb:item/helpers/potion_effect_hunger_0
...
execute if score effect_value value matches 124 run function itb:item/helpers/potion_effect_poison_4
