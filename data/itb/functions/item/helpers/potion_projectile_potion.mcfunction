...
# Merge data in
data modify entity @s Item.tag.CustomPotionEffects[0] set from storage itb:temp CustomPotionEffect
data modify entity @s Item.tag.CustomPotionColor set from storage itb:temp CustomPotionColor

# If item id was specified, write that to the entity
execute if data storage itb:working item[0].Effects[0].Text run data modify entity @s Item.id set from storage itb:working item[0].Effects[0].Text
