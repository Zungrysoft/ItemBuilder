...
execute store result score bottles_to_drop value run data get entity @s Inventory[{Slot:8b}].Count
...
# Fill this potion
item replace entity @s hotbar.8 with minecraft:potion
item modify entity @s hotbar.8 itb:fill_potion
