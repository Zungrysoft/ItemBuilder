...
# Reload the crossbow
item modify entity @s hotbar.0 itb:load_crossbow

# Reload multishot crossbow
execute if entity @s[nbt={Inventory:[{Slot:0b,tag:{Enchantments:[{id:"minecraft:multishot"}]}}]}] run item modify entity @s hotbar.0 itb:load_crossbow_multishot
