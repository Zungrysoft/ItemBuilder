...
# Reload the crossbow
item modify entity @s weapon.offhand itb:load_crossbow

# Reload multishot crossbow
execute if entity @s[nbt={Inventory:[{Slot:-106b,tag:{Enchantments:[{id:"minecraft:multishot"}]}}]}] run item modify entity @s weapon.offhand itb:load_crossbow_multishot
