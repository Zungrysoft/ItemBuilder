...
execute store result score bottles_to_drop value run data get entity @s Inventory[{Slot:4b}].Count
...
# Fill this potion
item replace entity @s hotbar.4 with minecraft:potion
item modify entity @s hotbar.4 itb:fill_potion
